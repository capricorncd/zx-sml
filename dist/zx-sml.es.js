      ...
      var e = {
          949: (e2, t2) => {
            Object.defineProperty(t2, '__esModule', { value: true }),
              (t2.toTwoDigits = void 0),
              (t2.toTwoDigits = function (e3) {
                return e3[1] ? e3 : '0' + e3
              })
          },
          607: (e2, t2, r) => {
            Object.defineProperty(t2, '__esModule', { value: true }),
              (t2.toTwoDigits = t2.toDate = t2.formatDate = void 0)
            var n = r(949)
            Object.defineProperty(t2, 'toTwoDigits', {
              enumerable: true,
              get: function () {
            ...
            function o(e3) {
              ...
              if (typeof e3 == 'number') return new Date(e3)
              if (typeof e3 == 'string') {
                var t3 = e3.trim()
                if (/^\d+$/.test(t3)) {
                  var r2 = t3.length
                  return r2 === 8
                    ...
                    : r2 === 6
                    ? new Date(
                        [t3.substr(0, 4), t3.substr(4, 2), '01'].join('/')
                      )
                    : r2 === 4
                    ? new Date(t3 + '/01/01')
                    : new Date(parseInt(e3))
                }
                if (
                  ((t3 = t3
                    .replace(/[年月日]/g, function (e4) {
                      return e4 === '\u65E5' ? '' : '/'
                    })
                    .replace(/[(（（].*?[)））]/g, ' ')
                    .replace(/\bam|pm\b/gi, ' ')
                    .replace(/\s+/g, ' ')),
                  /^(\d{4})[-/](\d{1,2})[-/](\d{1,2})$/.test(t3))
                )
            ...
            ;(t2.formatDate = function (e3, t3, r2) {
              var s,
                a = o(e3)
              if (!a || !t3) return e3 + ''
              if (t3 === 'timestamp') return a.getTime().toString()
              ;/(y+)/i.test(t3) &&
                ((s = RegExp.$1),
                (t3 = t3.replace(
                  s,
                  (a.getFullYear() + '').substr(4 - s.length)
                ))),
                (r2 && Array.isArray(r2.weeks)) || (r2 = i)
              var u = {
                'M+': a.getMonth() + 1,
                'd+': a.getDate(),
                'h+': a.getHours(),
              ...
              if (/(g)/i.test(t3)) {
                var p = a.toString().split(/\s+/).slice(5),
                  l = t3.includes('g')
...
function slice(arrLike, offset = 0) {
